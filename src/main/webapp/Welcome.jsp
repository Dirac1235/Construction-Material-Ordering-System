		...
		<div class="col col-lg-2 ml-3">
			...
			<ul class="list-group list-group-border-width-4 list-group-flush ">
				...
				<li><a class="list-group-item"
					href=<%="#" + rs3.getString(2)%>><%=rs3.getString(2)%></a></li>
				<%
				}
				%>
			</ul>
			...
			<div class="container">
				...
				<div class="row">
					...
					ResultSet rs2 = st2.executeQuery(
							"select material_id, name, description,image_url, price from material where category_id = " + rs.getInt(1));
					while (rs2.next()) {
					%>
					...
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href=<%="addToCart.jsp?p=" + rs2.getInt(1)%>><button
